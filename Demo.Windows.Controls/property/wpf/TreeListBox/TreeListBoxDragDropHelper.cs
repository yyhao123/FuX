...
namespace Demo.Windows.Controls.property.wpf
{
    ...
    public class TreeListBoxDragDropHelper
    {
        ...
        /// The drop position.
        /// </summary>
        private Demo.Windows.Controls.property.core.DropPosition dropPosition;
        ...
        private void DecideDropTarget(DragEventArgs e)
        {
            ...
            if (targetItemsControlCount > 0)
            {
                ...
                if (this.targetItemContainer != null)
                {
                    ...
                    {
                        this.dropPosition = Demo.Windows.Controls.property.core.DropPosition.Add;
                    }
                    else
                    {
                        this.dropPosition = relativePosition < 0.5
                                                ? Demo.Windows.Controls.property.core.DropPosition.InsertBefore
                                                : Demo.Windows.Controls.property.core.DropPosition.InsertAfter;
                    }
                }
                else
                {
                    ...
                    this.dropPosition = Demo.Windows.Controls.property.core.DropPosition.InsertAfter;
                }
            }
            else
            {
                this.targetItemContainer = null;
                this.dropPosition = Demo.Windows.Controls.property.core.DropPosition.InsertBefore;
            }

            if (this.targetItemContainer != null && draggedItems != null)
            {
                var dropTarget = this.targetItemContainer.DataContext as Demo.Windows.Controls.property.core.IDropTarget;
                foreach (var draggedItem in draggedItems)
                {
                    var dragSource = draggedItem as Demo.Windows.Controls.property.core.IDragSource;
                    if ((dragSource == null || !dragSource.IsDraggable)
                        || (dropTarget == null || !dropTarget.CanDrop(dragSource, this.dropPosition, (Demo.Windows.Controls.property.core.DragDropEffect)e.Effects)))
                    {
                        this.targetItemContainer = null;
        ...
        private void DragSourcePreviewMouseLeftButtonDown(object sender, MouseButtonEventArgs e)
        {
            ...
            {
                this.draggedData = new List<Demo.Windows.Controls.property.core.IDragSource>();
        ...
        private void DropTargetPreviewDrop(object sender, DragEventArgs e)
        {
            ...
            if (draggedItems != null)
            {
                ...
                var itemsToDrop = new List<Demo.Windows.Controls.property.core.IDragSource>();
                foreach (var draggedItem in draggedItems)
                {
                    var dragSource = draggedItem as Demo.Windows.Controls.property.core.IDragSource;
                    if (dragSource == null || !dragSource.IsDraggable)
                    ...
                    if (!dropTarget.CanDrop(dragSource, this.dropPosition, (Demo.Windows.Controls.property.core.DragDropEffect)e.Effects))
                    {
                        continue;
                    }
                ...
                dropTarget.Drop(itemsToDrop, this.dropPosition, (Demo.Windows.Controls.property.core.DragDropEffect)e.Effects, (Demo.Windows.Controls.property.core.DragDropKeyStates)this.initialKeyStates);
        ...
        {
            if (this.dropPosition == Demo.Windows.Controls.property.core.DropPosition.Add)
            {
                if (this.targetItemContainer != null)
                {
