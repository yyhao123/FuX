...
namespace Demo.Windows.Controls.property.wpf
{
    ...
    public class PropertyGridOperator : IPropertyGridOperator
    {
        ...
        protected IEnumerable<PropertyDescriptor> GetBrowsableProperties(PropertyDescriptorCollection properties)
        {
            ...
            {
                var portableBrowsableAttribute = pd.GetFirstAttributeOrDefault<Demo.Windows.Controls.property.core.DataAnnotations.BrowsableAttribute>();
        ...
        protected bool AreBrowsableAttributesJustTrue(PropertyDescriptorCollection propertyDescriptors)
        {
            var attributes = propertyDescriptors.OfType<PropertyDescriptor>()
              .Select(pd => Tuple.Create(pd.GetFirstAttributeOrDefault<Demo.Windows.Controls.property.core.DataAnnotations.BrowsableAttribute>(), pd.GetFirstAttributeOrDefault<System.ComponentModel.BrowsableAttribute>()))
              .ToArray();
        ...
        protected virtual void SetProperties(PropertyItem pi, object instance)
        {
            ...
            var ca2 = pi.GetAttribute<Demo.Windows.Controls.property.core.DataAnnotations.CategoryAttribute>();
            if (ca2 != null)
            {
        ...
        protected virtual void SetAttribute(Attribute attribute, PropertyItem pi, object instance)
        {
                ...
                if (columns != null)
                {
                    ...
                    foreach (Column column in columns)
                    {
                        ...
                        if (elementType != null)
                        {
                            ...
                            object[] descriptionAttributes = elementType.GetProperty(column.PropertyName)?.GetCustomAttributes(typeof(Demo.Windows.Controls.property.core.DataAnnotations.DescriptionAttribute), true);
                            if (descriptionAttributes != null && descriptionAttributes.Length > 0)
                            {
                                toolTip = ((Demo.Windows.Controls.property.core.DataAnnotations.DescriptionAttribute)descriptionAttributes[0]).Description;
                            }
                        }
            ...
            var ea2 = attribute as Demo.Windows.Controls.property.core.DataAnnotations.EditableAttribute;
            if (ea2 != null)
            {
