...
namespace Demo.Windows.Controls.property.wpf
{
    ...
    public static class ReflectionExtensions
    {
        ...
        public static List<object> FilterOnBrowsableAttribute<T>(this T arr) where T : IEnumerable
        {
            ...
            foreach (var o in arr)
            {
                ...
                if (field != null)
                {
                    ...
                    var browsable2 = field.GetCustomAttributes<Demo.Windows.Controls.property.core.DataAnnotations.BrowsableAttribute>(true).FirstOrDefault();
                    if (browsable2 != null)
                    {
                        // It is declared, is it true or false?
        ...
        {
            var a = pd.GetFirstAttributeOrDefault<Demo.Windows.Controls.property.core.DataAnnotations.ReadOnlyAttribute>();
            if (a != null)
            {
                return a.IsReadOnly;
            }
        ...
        {
            var a = pd.GetFirstAttributeOrDefault<Demo.Windows.Controls.property.core.DataAnnotations.CategoryAttribute>();
            if (a != null)
            {
                return a.Category;
            }
        ...
        {
            var a = pd.GetFirstAttributeOrDefault<Demo.Windows.Controls.property.core.DataAnnotations.DescriptionAttribute>();
            if (a != null)
            {
        ...
        {
            var a = pd.GetFirstAttributeOrDefault<Demo.Windows.Controls.property.core.DataAnnotations.DisplayNameAttribute>();
            if (a != null)
            {
